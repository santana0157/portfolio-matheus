    ...
    <footer className="max-container">
      <div className="flex justify-betweem items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/" className="text-3xl font-palanquin font-bold text-white">
            Matheus Santana
          </a>
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm ">
            Estudante de Ciências Econômicas, empreendedor e entusiasta de negócios baseado em Brasília - DF. Focado em projetos que unem estratégia, finanças e inovação.
          </p>
